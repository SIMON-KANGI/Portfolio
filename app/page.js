      ...
      <section id="display" className='grid lg:grid-cols-2 grid-cols-1 w-full my-6 h-screen'>
        ...
        <h1 className="text-center lg:text-left text-xl">Hello I'm</h1>
          ...
          <div className='py-3 lg:mx-0  my-4'>
            <button className='text-center lg:w-fit w-full my-2 hover:bg-black hover:border hover:border-rose-600 bg-rose-600 lg:px-8 py-3 rounded-md font-bold text-slate-100'>View Resume</button>
            <button className='text-center lg:w-fit w-full my-2 bg-black border border-rose-600 hover:bg-rose-600 lg:px-8 py-3 rounded-md font-bold text-slate-100'>Contact</button>
          </div>
          <div>
            <Socials/>
          </div>
